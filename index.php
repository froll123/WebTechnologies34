...
$job = [
    [
        'job_name' => 'Computer Operator',
        'job_date' => 'April 15 2017'
        'job_desc' => 'Issuing a TTN for the transportation of goods'
    ],

    [
        'job_name' => 'Programmer Technician',
        'job_date' => 'Feb 2017 - Nov 2019',
        'job_desc' => 'Software update and installation of software tools. Writing out documents related to the economic part.',
    ]

    [
        'job_name' => 'Leading System Analyst',
        'job_date' => 'Dec 2019 - Current',
        'job_desc' => 'Ensures the interaction of employees of the central office of the Ministry of Agriculture and Food with the Internet and control over its use;
                           conducts technical, program and information policy on the development of information systems of the Ministry of Agriculture and Food;
                           manages the local computer network of the Ministry of Agriculture and Food (performs the function of administrator);',
    ],
]
?>
